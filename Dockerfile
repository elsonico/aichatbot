...
#CMD gunicorn --config $GUNICORN_CONF $APP_MODULE
CMD ["gunicorn", "--certfile", "/etc/letsencrypt/live/vauva.ampiainen.net/fullchain.pem", "--keyfile", "/etc/letsencrypt/live/vauva.ampiainen.net/privkey.pem", "--ssl-version", "5", "--cert-reqs", "0", "--bind", "0.0.0.0:5005", "app:app"]
